<template>
  <div>
    <span id="pageHead"><h1>企业监管</h1></span><br>
    <!-- 查询模块 -->
    <div>
      <el-form :inline="true" align="left" label-width="80px">
        <el-form-item label="企业名称">
          <el-input v-model="entName" style="width: 436px"/>
        </el-form-item>
        <el-form-item label="认证状态">
          <el-select v-model="industry1" placeholder="全部">
            <el-option v-for="item in trades" :key="item.value" :label="item.label" :value="item.value"/>
          </el-select>
        </el-form-item><br>
    ...
    <div>
      <el-table :data='resultList' style='width: 100%'>
        ...
        <el-table-column prop='_status' label='认证状态' width='180px'>
        </el-table-column>
        <el-table-column prop='money' label='注册资本(万元)' width='180px'>
        </el-table-column>
        <el-table-column label='操作'>
          <el-button @click="detailReport" type='primary'>立即报告</el-button>
        </el-table-column>
      </el-table>
      <!-- 报告表单 -->
      <el-dialog title="招商报告" :visible.sync="dialogTableVisible">
...
export default {
  ...
  methods: {
    ...
    detailReport: function() {
      // console.log('获取id为:'+id+'的数据') 
      this.gridData = './401.gif'
